...
--
-- Name: index_lessons_on_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_lessons_on_content_type ON public.lessons USING btree (content_type);
